...
import { getAllUsers, deleteUserByEmail, updateUserEmail, getAllUserEmails, getUserDetails ,updateUserDetails,getUserNameByEmail,getUserLocationNamesByEmail,getSubLocationsByLocationName } from '../Controllers/userController.js';
...
router.put('/user-details/:userId/updateDetails', verifyToken, updateUserDetails);
